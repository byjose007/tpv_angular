...
class LanguageService {
        ...
        const languageServiceHost = {
            ...
            getScriptSnapshot: fileName => {
                if (!fileExistsSync(fileName))
                    return undefined;
                return typescript_1.ts.ScriptSnapshot.fromString(this._context.compilerFactory.addOrGetSourceFileFromFilePath(fileName, {
                    markInProject: false,
    ...
    getEmitOutput(filePathOrSourceFile, emitOnlyDtsFiles) {
        ...
        return new results_1.EmitOutput(this._context, filePath, getCompilerEmitOutput());
