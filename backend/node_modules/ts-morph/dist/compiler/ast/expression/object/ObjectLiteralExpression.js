...
class ObjectLiteralExpression extends exports.ObjectLiteralExpressionBase {
    ...
    insertProperties(index, structures) {
        ...
        index = manipulation_1.verifyAndGetIndex(index, properties.length);
        ...
        // get the properties
        return manipulation_1.getNodesToReturn(properties, this.getPropertiesWithComments(), index, true);
    }
    ...
    _insertProperty(index, structures, createStructurePrinter) {
        ...
        return manipulation_1.getNodesToReturn(oldProperties, this.getPropertiesWithComments(), index, false);
    }
}
