...
class SourceFile extends exports.SourceFileBase {
    ...
    getReferencedFiles() {
        if (this._referencedFiles == null) {
            this._referencedFiles = (this.compilerNode.referencedFiles || [])
                .map(f => new results_1.FileReference(f, this));
        }
    ...
    indent(positionRangeOrPos, times = 1) {
        ...
        const correctedText = utils_1.StringUtils.indent(sourceFileText.substring(startLinePos, endLinePos), times, {
