...
class VariableDeclarationList extends exports.VariableDeclarationListBase {
    ...
    insertDeclarations(index, structures) {
        ...
        index = manipulation_1.verifyAndGetIndex(index, originalChildrenCount);
        ...
        return manipulation_1.getNodesToReturn(originalChildrenCount, this.getDeclarations(), index, false);
    }
}
